...
public class DeployCommand {
    ...
    public String deploySnapshot(@Option(required = true, description =  HelpMessages.BUCKET_NAME) String bucketName,
                                 ...
                                 @Option(required = true, description =  HelpMessages.PREFIX) String prefix) throws IOException {

        return deployService.deploySnapshot(bucketName, prefix, folderPath, targetServer, null);
    }

    @Command(command = "verify")
    public String verify(@Option(required = true, description =  HelpMessages.PREFIX) String prefix,
    ...
    public String deployRelease(@Option(required = true, description =  HelpMessages.PREFIX) String prefix,
                                @Option(required = true, description =  HelpMessages.ARTIFACT_URL) String url,
                                @Option(required = true, description =  HelpMessages.BUCKET_NAME) String bucketName,
                                @Option(required = true, description =  HelpMessages.TARGET_SERVER) TargetServer targetServer,
                                @Option(description = HelpMessages.CHANGE_RECORD) String changeRecord) throws IOException {
