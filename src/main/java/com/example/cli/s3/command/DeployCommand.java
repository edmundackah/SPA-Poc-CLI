...
public class DeployCommand {
    ...
    public String deploySnapshot(@Option(required = true, description = Constants.PREFIX) String prefix,
                                 @Option(required = true, description = Constants.BUCKET_NAME) String bucketName,
                                 @Option(required = true, description = Constants.FOLDER_PATH) String folderPath,
                                 @Option(required = true, description = Constants.TARGET_SERVER) TargetServer server) throws IOException {

        return deployService.deploySnapshot(bucketName, prefix, folderPath, server, null);
    }

    @Command(command = "verify")
    public String verify(@Option(description = Constants.CHANGE_RECORD) String changeRecord,
                         @Option(required = true, description = Constants.PREFIX) String prefix,
                         @Option(required = true, description = Constants.BUCKET_NAME) String bucketName,
    ...
    public String remove(@Option(description = Constants.CHANGE_RECORD) String changeRecord,
                         @Option(required = true, description = Constants.PREFIX) String prefix,
                         @Option(required = true, description = Constants.BUCKET_NAME) String bucketName,
                         @Option(required = true, description = Constants.TARGET_SERVER) TargetServer server) {
    ...
    public String deployRelease(@Option(description = Constants.CHANGE_RECORD) String changeRecord,
                                @Option(required = true, description = Constants.PREFIX) String prefix,
                                @Option(required = true, description = Constants.ARTIFACT_URL) String url,
                                @Option(required = true, description = Constants.BUCKET_NAME) String bucketName,
                                @Option(required = true, description = Constants.TARGET_SERVER) TargetServer server) throws IOException {
